...
const SITE_STRUCTURE = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Mobile App Development', path: '/services', desc: 'Apps for Android and iPhone' },
      { label: 'Custom Software', path: '/services', desc: 'Bespoke business software' },
      { label: 'AI & Smart Automation', path: '/services', desc: 'Tools that handle repetitive work' },
      { label: 'Cybersecurity', path: '/services', desc: 'Security assessments and solutions' },
      { label: 'Complete Business Platforms', path: '/services', desc: 'Every department in one system' },
      { label: 'Accounting Systems', path: '/services', desc: 'Financial management software' },
      { label: 'Hosting & Uptime', path: '/services', desc: 'We keep your system online' },
      { label: 'Connected Devices & Automation', path: '/services', desc: 'Monitor equipment remotely' },
    ],
  },
  {
